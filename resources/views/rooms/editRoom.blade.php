    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        ...
        <option value="{{ $value }}" {{ $room->kategori == $value ? 'selected' : '' }}>{{ $value }}</option>
    @endforeach
                                            </select>
                                            <!-- error message untuk nama ruang -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" name="foto_depan" class="form control-file custom-file-input form-control @error('foto_depan') is-invalid @enderror" name="foto_depan" id="foto_depan" value="{{ old('foto_depan', $room->foto_depan) }}">
