                                ...
                                <div class="basic-form">
                                    <form action="{{ route('update-item', ['id' => $item->id]) }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <h6>Nomor Barang</h6>
                                            <input type="text" class="form-control input-default @error('no_barang') is-invalid @enderror" id="no_barang" name="no_barang" value="{{ old('no_barang', $item->no_barang) }}" placeholder="Misal: 101">
